...
// // };
// // const handleLogout = () => {
// //   // Ensure all cookie attributes match
// //   document.cookie = "auth=; path=/; max-age=0; expires=Thu, 01 Jan 1970 00:00:00 UTC; SameSite=Strict";
// //   window.location.href = "/login"; // triggers full reload, server sees no cookie
// // };

// const handleLogout = () => {
//   localStorage.removeItem("auth"); // ✅ clear auth state
//   window.location.href = "/login"; // force reload and go to login
// };
