...
//   useEffect(() => {
//     fetch("http://35.223.93.183:8001/available-datasets")
//       .then((res) => res.json())
//       .then((data) => {
...
//       const res = await fetch(`http://35.223.93.183:8001/llm-chat?${queryParams.toString()}`, {
//         method: "POST",
//         headers: {
...
//       if (json.imageUrl) {
//         try {
//           const imageRes = await fetch(`http://35.223.93.183:8001${json.imageUrl}`);
//           if (imageRes.ok) {
...
//       const res = await fetch(`http://35.223.93.183:8001/text-chat?${queryParams.toString()}`, {
//         method: "POST",
//         headers: {
//           Accept: "application/json",
//         },
...
const deleteFile = async () => {
  ...
  try {
    ...
    const response = await fetch("http://35.223.93.183:8001/delete", {
      method: "DELETE",
