...
//     Record<string, { indexKey: string; valueKey: string }>
//   >({});
...
//           fetch(`http://34.28.203.178:8001/${ds}`).then((r) => {
...
//                 strokeWidth={2}
//                 d="M12 9v2m0 4h.01M5.07 19H18.93a2 2 0 001.732-2.5L13.732 4a2 2 0 00-3.464 0L3.338 16.5A2 2 0 005.07 19z"
//               />
//             </svg>
//           </div>
//           <div>
...
//               {datasets.length} datasets • {totalDataPoints} total data points
//             </p>
//           </div>
...
//             <p className="text-gray-500">No datasets found. Try changing your search.</p>
//           </div>
//         ) : (
//           <div
...
//                   indexKey={indexKey}
//                   valueKey={valueKey}
//                   onSelectionChange={(newIndex, newValue) =>
//                     setSelectedColumns((prev) => ({
//                       ...prev,
//                       [ds]: { indexKey: newIndex, valueKey: newValue },
//                     }))
//                   }
//                   colors={colors}
...
//   indexKey: string;
//   valueKey: string;
//   onSelectionChange: (indexKey: string, valueKey: string) => void;
//   colors: string[];
//   colorIndex: number;
//   viewMode: "grid" | "list";
// }) {
...
//   return (
//     <Card className={`bg-white/80 backdrop-blur-md shadow-md hover:shadow-xl transition-all ${viewMode === "list" ? "flex flex-col lg:flex-row" : ""}`}>
//       <CardHeader className={`${viewMode === "list" ? "lg:w-1/3" : ""} pb-3`}>
//         <div className="flex justify-between items-start">
//           <div>
//             <CardTitle className="text-lg font-semibold">{dataset.replace(/[-_]/g, " ")}</CardTitle>
//             <CardDescription>{data.length} rows • {keys.length} columns</CardDescription>
//           </div>
...
//       <CardContent className={`${viewMode === "list" ? "lg:w-2/3" : ""} pt-0`}>
//         <div className="flex gap-2 mb-4">
//           <select
//             value={indexKey}
//             onChange={(e) => onSelectionChange(e.target.value, valueKey)}
...
//           <select
//             value={valueKey}
//             onChange={(e) => onSelectionChange(indexKey, e.target.value)}
//             className="flex-1 border border-gray-300 rounded-lg p-2 text-sm"
//           >
//             {keys
//               .filter((k) => k !== indexKey)
...
//           <BarChart
//             data={data.slice(0, isExpanded ? undefined : 10)}
//             index={indexKey}
//             categories={[valueKey]}
//             colors={[primaryColor]}
//             valueFormatter={(v) => `${v}`}
...
//             className="w-full mt-3 text-sm text-gray-600 hover:text-blue-600"
//           >
