...
// //       `http://34.28.203.178:8001/llm-chat?prompt=${encodeURIComponent(text)}&dataset=gdp&model=deepseek`,
// //       {
// //         method: 'POST',
// //       }
// //     );
...
//   try {
//     const response = await fetch(`http://34.28.203.178:8001/llm-chat?${queryParams.toString()}`, {
//       method: 'POST',
//     });
